...
<div>
  <div style="margin-bottom: 24px;">
    ...
    <p style="font-size: 11px; color: var(--text-muted); margin-top: 4px;">
      World Cup 2026 · {data.daysUntil > 0 ? `${data.daysUntil} días para el mundial` : '¡El mundial ha comenzado!'}
    </p>
  </div>
  ...
  <section style="margin-bottom: 24px;">
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 12px;">
      <h2 style="font-size: 10px; letter-spacing: 0.15em; text-transform: uppercase; color: var(--text-muted);">My Pools</h2>
      <a href="/pools/create" class="btn-primary" style="font-size: 9px; padding: 6px 14px;">+ New Pool</a>
    </div>
    ...
    {#if data.pools.length === 0}
      <div style="background: var(--bg-card); border: 1px solid var(--border); border-radius: 8px; padding: 32px; text-align: center;">
        ...
        <p style="font-size: 12px; color: var(--text-muted); margin-bottom: 12px;">No pools yet. Create one or join with an invite code!</p>
          ...
          <a href="/pool/{pool.id}" style="display: block; background: var(--bg-card); border: 1px solid var(--border); border-radius: 8px; padding: 14px 16px; transition: border-color 0.15s; text-decoration: none;">
            <div style="display: flex; justify-content: space-between; align-items: center;">
              ...
              <div style="text-align: right;">
                {#if pool.has_paid}
                  <span style="font-size: 9px; color: var(--green); letter-spacing: 0.1em; text-transform: uppercase;">✓ Paid</span>
                {:else if pool.buy_in > 0}
                  <span style="font-size: 9px; color: var(--gold); letter-spacing: 0.1em; text-transform: uppercase;">Unpaid</span>
                {/if}
              </div>
            </div>
          </a>
  ...
  <!-- Quick Stats -->
  <section>
    <h2 style="font-size: 10px; letter-spacing: 0.15em; text-transform: uppercase; color: var(--text-muted); margin-bottom: 12px;">Quick Stats</h2>
    <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 8px;">
      <div style="background: var(--bg-card); border: 1px solid var(--border); border-radius: 8px; padding: 14px; text-align: center;">
        ...
        <div style="font-size: 9px; color: var(--text-muted); letter-spacing: 0.1em; text-transform: uppercase; margin-top: 2px;">Pools</div>
      </div>
      <div style="background: var(--bg-card); border: 1px solid var(--border); border-radius: 8px; padding: 14px; text-align: center;">
        <div style="font-size: 20px; font-weight: 700; color: var(--gold);">48</div>
        <div style="font-size: 9px; color: var(--text-muted); letter-spacing: 0.1em; text-transform: uppercase; margin-top: 2px;">Teams</div>
      </div>
      <div style="background: var(--bg-card); border: 1px solid var(--border); border-radius: 8px; padding: 14px; text-align: center;">
        <div style="font-size: 20px; font-weight: 700; color: var(--gold);">104</div>
        <div style="font-size: 9px; color: var(--text-muted); letter-spacing: 0.1em; text-transform: uppercase; margin-top: 2px;">Matches</div>
      </div>
    </div>
  </section>
</div>
